...
CREATE INDEX idx_qi_industry ON question_industries(industry_id);
...
CREATE INDEX idx_qr_role ON question_roles(role_id);
...
CREATE INDEX idx_ti_industry ON task_industries(industry_id);
